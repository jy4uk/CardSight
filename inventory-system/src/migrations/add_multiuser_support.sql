...
ALTER TABLE inventory ADD COLUMN IF NOT EXISTS user_id INTEGER NOT NULL DEFAULT 1 REFERENCES users(id);
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS user_id INTEGER NOT NULL DEFAULT 1 REFERENCES users(id);
ALTER TABLE trades ADD COLUMN IF NOT EXISTS user_id INTEGER NOT NULL DEFAULT 1 REFERENCES users(id);
ALTER TABLE card_shows ADD COLUMN IF NOT EXISTS user_id INTEGER NOT NULL DEFAULT 1 REFERENCES users(id);
...
VALUES ('admin@cardpilot.com', '$2b$10$rQZ8ZqGQJqKqQqQqQqQqQu', 'Admin', 'User')
