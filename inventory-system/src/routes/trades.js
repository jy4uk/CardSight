  ...
  try {
    ...
    for (const item of trade_in_items) {
      ...
      const [newItem] = await query(`
        INSERT INTO inventory (user_id, barcode_id, card_name, set_name, game, card_type, condition, purchase_price, purchase_date, front_label_price, status, notes, cert_number, card_number, grade, grade_qualifier, image_url)
