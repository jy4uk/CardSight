...
import { fetchCardLadderStatus, connectCardLadderEmail, connectCardLadderToken, connectCardLadderGoogle, disconnectCardLadder } from '../api';
...
export default function AccountSettings({ onClose, onRestartTutorial }) {
  ...
  const handleClConnectGoogle = async () => {
    setClConnecting(true);
    try {
      await connectCardLadderGoogle();
      ...
      if (code === 'auth/unauthorized-domain') {
        toast.error('Google sign-in blocked in production (domain not whitelisted). Use the manual token option below.');
              ...
              <div className="border border-gray-200 rounded-lg p-5">
                ...
                {clStatus?.valid ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      type="button"
                      onClick={handleClConnectGoogle}
                      disabled={clConnecting}
                      className="flex items-center justify-center gap-3 w-full px-4 py-2.5 border border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700 disabled:opacity-50"
                    >
                      {clConnecting ? (
                    ...
                    {/* Email/password for non-Google accounts */}
                    <div>
                      <button
                        type="button"
                      ...
                      {clShowManual && (
                        <div className="mt-3 space-y-4">
                          ...
                          <div className="pt-3 border-t border-gray-100">
                            <p className="text-xs font-medium text-gray-700 mb-2">Paste refresh token manually</p>
                            <div className="bg-gray-50 rounded-lg p-3 text-xs mb-3">
                              <p className="text-gray-600 mb-2">Run this in DevTools on <a href="https://app.cardladder.com" target="_blank" rel="noreferrer" className="text-blue-600 underline">app.cardladder.com</a> (Console tab):</p>
