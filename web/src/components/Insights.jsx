...
export default function Insights() {
  ...
  const MetricCard = ({ title, value, icon: Icon, trend, color = 'blue', modalType, modalData }) => {
    ...
    return (
    <div 
      className={`bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 lg:p-6 ${modalType ? 'cursor-pointer hover:shadow-md transition-shadow' : ''}`}
    ...
    >
      ...
      <h3 className="text-gray-500 text-[10px] sm:text-xs lg:text-sm font-medium truncate">{title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-lg sm:text-xl font-semibold text-gray-900">Insights</h1>
            </div>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <select
                ...
                className="px-2 sm:px-3 py-1.5 border border-gray-300 rounded-lg text-xs sm:text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              >
