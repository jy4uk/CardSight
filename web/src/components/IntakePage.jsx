...
export default function IntakePage({ 
  ...
  return (
    <>
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-4 pb-24 sm:pb-4">
        ...
        <div className="flex flex-col gap-4 lg:grid lg:grid-cols-2 lg:h-[calc(100vh-8rem)]">
          {/* Purchases */}
          <div className={`bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col ${expandedSections.purchases ? 'min-h-[70vh] sm:min-h-[50vh] lg:min-h-0' : ''}`}>
          ...
          {/* Trades */}
          <div className={`bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col ${expandedSections.trades ? 'min-h-[70vh] sm:min-h-[50vh] lg:min-h-0' : ''}`}>
          ...
          {/* Saved Deals */}
          <div className={`bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col ${expandedSections.savedDeals ? 'min-h-[70vh] sm:min-h-[50vh] lg:min-h-0' : ''}`}>
          ...
          {/* Pending Barcodes */}
          <div className={`bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col ${expandedSections.pendingBarcodes ? 'min-h-[70vh] sm:min-h-[50vh] lg:min-h-0' : ''}`}>
